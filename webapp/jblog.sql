...
SET DEFINE OFF;
Insert into JBLOG.BLOG (ID,BLOGTITLE,LOGOFILE) values ('admin','운영자의 블로그입니다.','spring-logo.jpg');
Insert into JBLOG.BLOG (ID,BLOGTITLE,LOGOFILE) values ('qwer','유호준의 블로그입니다.','spring-logo.jpg');
REM INSERTING into JBLOG.CATEGORY
SET DEFINE OFF;
Insert into JBLOG.CATEGORY (CATENO,ID,CATENAME,DESCRIPTION,REGDATE) values (1,'admin','미분류','기본으로 만들어지는 카테고리 입니다.',to_date('22/02/09','RR/MM/DD'));
Insert into JBLOG.CATEGORY (CATENO,ID,CATENAME,DESCRIPTION,REGDATE) values (2,'qwer','미분류','기본으로 만들어지는 카테고리 입니다.',to_date('22/02/10','RR/MM/DD'));
...
SET DEFINE OFF;
Insert into JBLOG.USERS (USERNO,ID,USERNAME,PASSWORD,JOINDATE) values (1,'admin','운영자','admin',to_date('22/02/09','RR/MM/DD'));
Insert into JBLOG.USERS (USERNO,ID,USERNAME,PASSWORD,JOINDATE) values (2,'qwer','유호준','1234',to_date('22/02/10','RR/MM/DD'));
--------------------------------------------------------
